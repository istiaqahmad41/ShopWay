...
import '../widgets/ForgetPasswordButton.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                PrimaryButton(
                  buttonName: "Sign Up",
                  onpressed: () {
                    controller.adminRegister(context,username.text.trim(), email.text.trim(), password.text.trim());
                ...
                Row(
                  ...
                  children: [
                    ...
                    OptionButton(
                      textcolor: Colors.black,
                      buttonName:"Sign In", onPressed: () {  Navigator.pop(context);},
                    ),
                  ],),
